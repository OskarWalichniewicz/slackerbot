...
segment_list = ['Imma Kamehameha yo ass if you don\'t behave kids!',
                ...
                'Mama told me to not talk to strangers!',
...
awy_list = ['MONSTRUJM',
            ...
            'kocham cije',
            'whenever i think about marriage i always remember that every gf i brought home would get along with ma mom and sisster and then it was fucked up',
            ...
            'well my mother is like me you can\'t take us to seriously\nunless we are mad\nthat\'s when you take us seriously',
            'we insult each other in SErbia alot\nyou see man on a street\nyou tell him your mom is a whore he wont get mad\nhe will hug you\nlike where\'s my bro',
            'ye interstellar was good af but i always sucked at psyics and there were alot of termins about it there',
            'and you can\'t smoke in cinema imagine surviving in closed room for 2+ hrs without taking a smoke',
            'DENI BOI THE CRINGE MASTER',
            'yes and to remain nice you gotta get rid of unnice ones',
            'you will be one of them that will marry the women who will fuck with every single guy in your town,then she will divorce y ou and take all your property and you will be a hobo beneth that same bridge where your friend got a fking ticket for driving across it',
            'i would bang cenelia',
            'In a world where everyone\'s guilty,the only crime is getting caught. In a wor ld of thieves the one final sin is stuipidity',
