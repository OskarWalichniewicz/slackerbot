...
@client.command()
async def english(ctx, *, translate):
    await ctx.send(translate_english(translate))

@client.command()
async def dutch(ctx, *, translate):
    await ctx.send(translate_dutch(translate))

@client.command()
async def italian(ctx, *, translate):
